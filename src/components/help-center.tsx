// src/features/help-center/index.tsx (ajuste o path conforme seu projeto)
...
const guides: GuideConfig[] = [
  {
    ...
    subtitle: 'Entenda o painel de candidaturas e o significado de cada status.',
  },
  {
    id: 'resumes',
...
export function HelpCenter() {
  ...
  return (
    <>
      {/* ===== Header (igual outras páginas, resolve o “sumiu menu no mobile”) ===== */}
      <Header fixed>
        <Search />
      ...
      <Main className='flex flex-1 flex-col'>
        <div className='mx-auto flex w-full max-w-5xl flex-col gap-6 py-6 md:py-10'>
          {/* Header da página */}
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-muted-foreground text-sm'>
                  Guias rápidos para tirar o máximo da plataforma sem
                  complicação.
                </p>
              </div>
            </div>
            ...
            <CardContent className='grid gap-3 md:grid-cols-3'>
              <div className='space-y-1'>
                ...
                <p className='text-muted-foreground text-xs'>
                  Revise seu nome, localização, senioridade e áreas de interesse
                  com frequência.
                </p>
              </div>
              <div className='space-y-1'>
                ...
                <p className='text-muted-foreground text-xs'>
                  Tenha versões diferentes do currículo para áreas específicas
                  (por exemplo: backend, QA, liderança).
                </p>
              </div>
              <div className='space-y-1'>
                <p className='text-sm font-medium'>Acompanhe os status</p>
                <p className='text-muted-foreground text-xs'>
                  Use o painel de candidaturas diariamente para saber onde focar
                  seu esforço.
                </p>
              </div>
            </CardContent>
          ...
          >
            <p className='text-muted-foreground text-sm'>
              No painel de candidaturas você vê todas as vagas em que se
              candidatou, com status como <strong>Candidatado</strong>,{' '}
            ...
            <ul className='text-muted-foreground mt-3 list-disc space-y-1 ps-4 text-sm'>
              ...
              <li>
                A data de <strong>Candidatado em</strong> ajuda a entender a
                linha do tempo de cada vaga.
              </li>
              <li>
          ...
          >
            ...
            <ul className='text-muted-foreground mt-3 list-disc space-y-1 ps-4 text-sm'>
              ...
              <li>
                Na hora de se candidatar, selecione o currículo que mais
                conversa com a vaga.
              </li>
            </ul>
          </GuideDialog>
          ...
          >
            <p className='text-muted-foreground text-sm'>
              Os filtros ajudam a reduzir a lista de vagas e focar nas
          ...
          >
            <p className='text-muted-foreground text-sm'>
              Quando uma candidatura evolui para entrevista, é importante
              organizar bem suas etapas.
            </p>
            <ul className='text-muted-foreground mt-3 list-disc space-y-1 ps-4 text-sm'>
              <li>
              ...
              <li>
                Mantenha anotações pessoais fora da plataforma (ex.: bloco de
                notas) com perguntas e feedbacks.
              </li>
              <li>
          ...
          >
            ...
            <ul className='text-muted-foreground mt-3 list-disc space-y-1 ps-4 text-sm'>
              <li>
                Responda mensagens o quanto antes para não perder prazos de
                testes ou entrevistas.
              </li>
              <li>Seja objetivo, educado e profissional em todas as conversas.</li>
              <li>
                Use as mensagens para tirar dúvidas sobre escopo, modelo de
                trabalho e etapas do processo.
              </li>
            </ul>
          </GuideDialog>
          ...
          >
            <p className='text-muted-foreground text-sm'>
              Um perfil atualizado aumenta as chances de receber vagas e
              abordagens mais relevantes.
            </p>
            <ul className='text-muted-foreground mt-3 list-disc space-y-1 ps-4 text-sm'>
              <li>
          ...
          >
            <p className='text-muted-foreground text-sm'>
              Configure notificações para não perder mudanças importantes nas
              suas candidaturas.
            </p>
            <ul className='text-muted-foreground mt-3 list-disc space-y-1 ps-4 text-sm'>
              <li>
                Ative alertas para quando uma candidatura mudar de status ou
                surgir uma nova mensagem.
              </li>
              <li>
                No futuro, você poderá escolher entre notificações por e-mail,
                web ou mobile.
              </li>
              <li>
                Se estiver recebendo muitas notificações, ajuste as preferências
                em configurações.
              </li>
            </ul>
          </GuideDialog>
...
function GuideDialog({ open, onOpenChange, title, children }: GuideDialogProps) {
  return (
